...
- **MCP Launch**: `r2d2 mcp-start --service <name>` starts configured services with `start_command` metadata; the dashboard tool status bar exposes the same launcher for unavailable MCP services.
